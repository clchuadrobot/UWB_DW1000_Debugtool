...
int GetLocation(vec3d *best_solution, int use4thAnchor, vec3d* anchorArray, int *distanceArray, double *sumerror)
{
...
int Get_Best_Position(void)
{
	  int result = 0;
		...
		anchorArray[0].x = 0.000f; //anchor0.x uint:m
    anchorArray[0].y = 0.000f; //anchor0.y uint:m
    anchorArray[0].z = 0.000f; //anchor0.z uint:m

    anchorArray[1].x = 0.000f; //anchor1.x uint:m
    anchorArray[1].y = 7.250f; //anchor1.y uint:m
    anchorArray[1].z = 0.000f; //anchor1.z uint:m

    anchorArray[2].x = 5.300f; //anchor2.x uint:m
    anchorArray[2].y = 7.250f; //anchor2.y uint:m
    anchorArray[2].z = 0.000f; //anchor2.z uint:m

    anchorArray[3].x = 5.300f; //anchor3.x uint:m
    anchorArray[3].y = 0.000f; //anchor3.y uint:m
    anchorArray[3].z = 0.000f; //anchor3.z uint:m
...
//		Range_deca[3] = 7021; //tag to A3 distance 
		...
		result = GetLocation(&report, 0, &anchorArray[0], &Range_deca[0], &sumerror);	
		return result;
}
